import { useGetUserFavorites } from '../hooks/useQueries';
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-16">
          ...
          <p className="text-muted-foreground text-lg mb-4">Please log in to view your favorites</p>
          <Link to="/">
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold flex items-center gap-3">
          <Heart className="w-8 h-8 text-[oklch(0.65_0.25_25)]" />
          My Favorites
        </h1>
      </div>
